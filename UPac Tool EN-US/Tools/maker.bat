...
title Unisoc Integration Package Maker Tool
...
if /i not "!confirmed!"=="Y" (
    echo Please complete the device preparation first
    rmdir /s /q "!work_dir!"
    pause
    goto start
)
...
adb shell reboot
echo Files retrieved successfully, device rebooted, you can disconnect now.
